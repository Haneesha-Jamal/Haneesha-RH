...
namespace DomainDAL.Services.Admin
{
    ...
    {
        private readonly List<DomainDAL.Model.JobSeeker> _jobSeeker;
         ApiWorkShopDbcontext _context;
        IMapper _mapper;

        public AdminRepository(ApiWorkShopDbcontext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
