...
using DomainDAL.Enums;

namespace DomainDAL.Service.Authuser
{
    public class AuthUserRepository: IAuthUserRepository
    {
        ...
        public AuthUserRepository(ApiWorkShopDbcontext dbContext,IMapper _mapper, IConfiguration configuration)
        {
            _context = dbContext;
            mapper = _mapper;
        ...
        public async Task<AuthUser> AddAuthUser(AuthUser authUser)
        {
            ...
            authUser.Role = Enums.Roles.JOB_SEEKER;
            await  _context.AuthUsers.AddAsync(authUser);
            Model.JobSeeker jobSeeker = mapper.Map<Model.JobSeeker>(authUser);
